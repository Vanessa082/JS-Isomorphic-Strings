...
refresh.innerHTML = '<span class="material-symbols-outlined" style="color: #000; padding: 5px;">refresh</span>'
firstString.placeholder = 'Enter the first string...'
secondString.placeholder = 'Enter the second string...'
check.innerHTML = '<span class="material-symbols-outlined" style="color: #000; padding: 5px;">check</span>'
